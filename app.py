...
그린북: 재정경제부가 매월 발표하는 경제 동향 보고서 
환헤지: 미래 환율을 현재 시점에 미리 고정해두는 금융 기법
기간제법: 기간제 근로자를 2년 이상 고용하면 정규직으로 전환하자는 취지의 법안
브랜트유: 영국과 노르웨이 인근 북해 지역에서 생산되는 원유로 세계 원유 가격을 결정하는 대표적인 기준유 
AI 기본소득: 인공지능 기술이 창출한 경제적 이익을 사회에 분배하는 정책 구상
사법 3법: 법 왜곡죄, 헌법 재판소원, 대법관 증원(14명->26명)을 묶어 부르는 말
"""
